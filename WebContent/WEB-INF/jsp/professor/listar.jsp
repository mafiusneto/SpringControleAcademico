    ...
    <table class="table table-striped " style="margin:auto"> <!--    table-responsive-inverse -->
		...
		<c:forEach var="professor" items="${professores}">
			<tr>
				...
				<td>
					<a href="${url}/${professor.id}/update"><button type="button" class="btn btn-warning">Editar</button></a>
					<!-- <a href="${url}/${professor.id}/excluir"><button type="button" class="btn btn-warning">Excluir</button></a> -->
				</td> 
