...
<body>
	...
	<form class="form-horizontal" method="post" action="${url}"  modelAttribute="turma">
		...
		<div class="form-group">
		  <label class="col-md-4 control-label" for="semestre">Professor</label>  
		  <div class="col-md-4">		  	  
			<c:forEach var="professor" items="${professores}">
				<div class="radio">
				  <label><input type="radio" name="professor" value="${professor}">${professor.nome} - ${professor.matricula}</label>
				</div>
			</c:forEach>
		  </div>
		</div>
