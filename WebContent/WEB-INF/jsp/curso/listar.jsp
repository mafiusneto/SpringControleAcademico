    ...
    <table class="table table-striped " style="margin:auto"> <!--    table-responsive-inverse -->
		...
		<c:forEach var="curso" items="${cursos}">
			<tr>
				...
				<td>${curso.tipo}</td>
				<td>
					<a href="${url}/${curso.id}/update"><button type="button" class="btn btn-warning">Editar</button></a>
					<!-- <a href="${url}/${curso.id}/excluir"><button type="button" class="btn btn-warning">Excluir</button></a> -->
				</td> 
