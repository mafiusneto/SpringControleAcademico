    ...
    <table class="table table-striped " style="margin:auto"> <!--    table-responsive-inverse -->
		...
		<c:forEach var="aluno" items="${alunos}">
			<tr>
				...
				<td>
					<a href="${url}/${aluno.id}/update"><button type="button" class="btn btn-warning">Editar</button></a>
					<!-- <a href="${url}/${aluno.id}/excluir"><button type="button" class="btn btn-warning">Excluir</button></a> -->
				</td> 
